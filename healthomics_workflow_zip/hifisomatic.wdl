...
workflow hifisomatic {
  ...
  scatter (case in cohort.samples) {
    ...
    # Patient is now clone_unit 
    # patient_tumor_bam_files is sample_tumor_bam_files
    # patient_normal_bam_files is sample_normal_bam_files
    # Go through this main wdl as well as all the task wdl to make these changes
    ...
    call alignment.align_all_bams {
      input:
        sample = sample,
        sample_tumor_bam_files = sample_tumor_bam_files,
        sample_normal_bam_files = sample_normal_bam_files,
